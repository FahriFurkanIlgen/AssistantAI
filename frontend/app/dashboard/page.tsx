    ...
    <div className="p-8 max-w-[960px]">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        <div className="bg-white border border-apple-border rounded-apple p-5">
          <p className="text-[12px] text-apple-secondary uppercase tracking-wide">
            Bugün
          </p>
          <p className="text-[32px] font-display font-semibold text-apple-ink mt-1">
            {todayCount}
          </p>
          <p className="text-[11px] text-apple-secondary mt-1">randevu</p>
        </div>
        <div className="bg-white border border-apple-border rounded-apple p-5">
          <p className="text-[12px] text-apple-secondary uppercase tracking-wide">
            Bu Ay
          </p>
          <p className="text-[32px] font-display font-semibold text-apple-blue mt-1">
            {stats?.this_month ?? "—"}
          </p>
          {monthChange !== null && (
            <p
              className={`text-[11px] mt-1 ${monthChange >= 0 ? "text-green-600" : "text-red-500"}`}
            >
        ...
        <div className="bg-white border border-apple-border rounded-apple p-5">
          ...
          <p className="text-[11px] text-apple-secondary mt-1">yaklaşan</p>
        </div>
        <div className="bg-white border border-apple-border rounded-apple p-5">
          <p className="text-[12px] text-apple-secondary uppercase tracking-wide">
            İptal Oranı
          ...
          <p
            className={`text-[32px] font-display font-semibold mt-1 ${(stats?.cancel_rate_percent ?? 0) > 20 ? "text-red-500" : "text-apple-ink"}`}
          >
            {stats?.cancel_rate_percent ?? "—"}
            {stats ? "%" : ""}
          </p>
          <p className="text-[11px] text-apple-secondary mt-1">bu ay</p>
        </div>
      </div>
...
export default function DashboardPage() {
  ...
  const stats = [
    ...
    },
    {
      ...
      color: profile?.google_connected
        ? "text-apple-blue"
    ...
    <div className="p-8 max-w-[900px]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        {stats.map((s) => (
          <div
            key={s.label}
            className="bg-white border border-apple-border rounded-apple p-6"
          >
            <p className="text-[13px] text-apple-secondary">{s.label}</p>
            <p
              className={`text-[32px] font-display font-semibold mt-1 tracking-tight ${s.color}`}
            >
              {s.value}
            </p>
          </div>
